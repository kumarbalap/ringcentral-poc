$(function() {
    ...
    function register(data) {
        ...
        var sdk = new RingCentral.SDK({
            appKey: APP_CREDENTIALS['appKey'],
            appSecret: APP_CREDENTIALS['appSecret'],
            server: APP_CREDENTIALS['server']
        });   
    ...
    login(
        APP_CREDENTIALS['server'], 
        APP_CREDENTIALS['appKey'], 
        APP_CREDENTIALS['appSecret'],
        APP_CREDENTIALS['login'], 
        APP_CREDENTIALS['ext'], 
        APP_CREDENTIALS['password'], 
        APP_CREDENTIALS['logLevel']
    );  
