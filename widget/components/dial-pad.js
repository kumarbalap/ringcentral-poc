    ...
    this.element = {
        ...
        panel: dom('div', {
            ...
            wrapper: dom('div', {
                ...
                dialButtonStar: dom('button', {
                    className: 'rc-dial-button',
                    text: '+'
                }, { click: this.dialing.bind(this, '+') }),
                dialButton0: dom('button', {
                    className: 'rc-dial-button',
                    text: '0'
                }, { click: this.dialing.bind(this, '0') }),
                dialButtonBS: dom('button', {
                    className: 'rc-dial-button rc-del-button',
                    text: 'DEL'
                }, { click: this.deleteNo.bind(this) }),                
            }),
            calloutButton: dom('button', {
                className: 'rc-call-button',
                text: 'Call'
...
DialPad.prototype.deleteNo = function() {
    total = this.element.panel.number.value;
    total = total.slice(0, -1);
    this.element.panel.number.value = total;
};
